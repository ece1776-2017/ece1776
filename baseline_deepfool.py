...
from cleverhans.attacks import DeepFool,FastGradientMethod
...
def baseline_deepfool(train_start=0, train_end=60000, test_start=0,
 ...
 # Get MNIST test data
    ...
    def evaluate_2():
        ...
        accuracy = model_eval(sess, x, y, preds_2_adv, X_test,
                              Y_test, args=eval_params)
        print('Test accuracy on DeepFool adversarial examples: %0.4f' % accuracy)
...
# Calculate training errors
    ...
    return report
def main(argv=None):
    baseline_deepfool(nb_epochs=FLAGS.nb_epochs, batch_size=FLAGS.batch_size,
